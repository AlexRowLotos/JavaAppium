...
public class SearchPageObjectAndroid extends SearchPageObject {
    ...
    static {
        ...
        SEARCH_RESULT_TPL = "xpath://*[@resource-id='org.wikipedia:id/page_list_item_title'][contains(@text, '(SUBSTRING)')]";
    ...
    public SearchPageObjectAndroid(RemoteWebDriver driver)
    {
        super(driver);
    }
}